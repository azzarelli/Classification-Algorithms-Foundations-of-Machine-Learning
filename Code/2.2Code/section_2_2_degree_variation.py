...
train_split_ratio = 0.9 # training split as a ratio of total data:  # of training / total # of data
...
plt.plot([i for i in range(1,test_its)], msr_plot_A, color='green', label='PBF')
plt.plot([i for i in range(1,test_its)], msr_plot_B, color='blue', label='GRBF')
# adding true sine
